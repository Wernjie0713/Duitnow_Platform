import{j as e}from"./app-DAekorQq.js";import{D as o,a as n,b as s,c as r,d as c,e as l}from"./dialog-BRijTaJQ.js";import"./createLucideIcon-KDruThoH.js";import"./index-COzFNtqB.js";import"./utils-BM_CldAA.js";function f({}){const t=`1. Open to all registered UTM students in Campus JB, KL, and Pagoh.
...
`).map(i=>i.trim());return e.jsxs(o,{children:[e.jsx(n,{className:"font-medium",children:"Terms and Condition"}),e.jsx(s,{children:e.jsxs(r,{children:[e.jsx(c,{children:"Terms and Condition"}),e.jsx(l,{className:"text-left",children:t.map((i,a)=>e.jsx("p",{children:i},a))})]})})]})}export{f as default};
