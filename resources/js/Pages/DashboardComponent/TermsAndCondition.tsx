...
export default function TermsAndCondition({ }) {
    const text = `1. Open to all registered UTM students in Campus JB, KL and Pagoh
                ...
                5. Top 10 participants with the highest transaction counts during the month will be rewarded.
                6. To be eligible for prizes, minimum transaction counts is 100.
                7. Winners will be announced within 5 working days of each prize period
